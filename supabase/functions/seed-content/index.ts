...
const pages = [
  ...
  },
  {
    ...
    sections: [
      { section_id: "introduction", section_type: "heading", title: "Introduction", content: { text: "Introduction" } },
      { section_type: "paragraph", content: { text: "To identify **transmission channels** and **financial risks**, **technology**, **legal**, and **policy transition risks** must be identified so clients' **actual exposure** and **business model impact** can be assessed." } },
      ...
      { section_type: "paragraph", content: { text: "Understanding **bottom-up transition risks** and **underlying drivers** is a **critical exercise** for lenders." } },
      ...
      { section_type: "paragraph", content: { text: "Technology risk includes **data and security breaches**, **cybersecurity risks**, **AI and algorithmic risks**, and **obsolescence** of materials, processes and assets." } },
      ...
      { section_type: "paragraph", content: { text: "Policy risks arise from **government actions** to promote **transition to a low-carbon economy**, including **carbon pricing**, **emissions regulations**, and **sector-specific mandates**." } },
